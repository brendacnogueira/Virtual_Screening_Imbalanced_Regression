...
from sera_opt_proto import phi_control
        ...
        for trial, (train_idx, test_idx) in enumerate(data_splitter.split(split_dat)):
           ...
           # continue
            ...
            if model=="GCN":
                ...
                #ph=phi_control(pd.Series(training_set_u.y,dtype="float64"),extr_type="high")
                ph={"method":"range","npts": 3,"control_pts":[0,0,0,8,0.1,0,9,1,0]}
                print(ph)
               ...
               # gcn_path=model_fpath+"graphconv_model.pth"
                ...
                model_eval_train = Model_Evaluation(ml_model, training_set, train_idx, sel_metric, ph, smiles_train,
                                                        training_set_u.y, transformers[0], model_id=model)
                
                model_eval_test = Model_Evaluation(ml_model, test_set,test_idx, sel_metric, ph, smiles_test,
                ...
                model_eval_train = Model_Evaluation(ml_model, training_set, train_idx, sel_metric,ph)
                model_eval_test = Model_Evaluation(ml_model, test_set, test_idx, sel_metric,ph)
